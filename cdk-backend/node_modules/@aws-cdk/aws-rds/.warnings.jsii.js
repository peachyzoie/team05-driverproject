    ...
    try {
        if (p.replicaRegions != null)
            for (const o of p.replicaRegions)
                if (!visitedObjects.has(o))
                    require("@aws-cdk/aws-secretsmanager/.warnings.jsii.js")._aws_cdk_aws_secretsmanager_ReplicaRegion(o);
    }
    finally {
        visitedObjects.delete(p);
    }
    ...
    try {
        if (p.configurations != null)
            for (const o of p.configurations)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_OptionConfiguration(o);
        if (!visitedObjects.has(p.engine))
    ...
    try {
        if (p.dbClusters != null)
            for (const o of p.dbClusters)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_IDatabaseCluster(o);
        if (p.dbInstances != null)
            for (const o of p.dbInstances)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_IDatabaseInstance(o);
    }
    finally {
        visitedObjects.delete(p);
    }
    ...
    try {
        if (p.secrets != null)
            for (const o of p.secrets)
                if (!visitedObjects.has(o))
                    require("@aws-cdk/aws-secretsmanager/.warnings.jsii.js")._aws_cdk_aws_secretsmanager_ISecret(o);
        if (p.securityGroups != null)
            for (const o of p.securityGroups)
                if (!visitedObjects.has(o))
                    require("@aws-cdk/aws-ec2/.warnings.jsii.js")._aws_cdk_aws_ec2_ISecurityGroup(o);
        if (p.sessionPinningFilters != null)
            for (const o of p.sessionPinningFilters)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_SessionPinningFilter(o);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_aws_rds_CfnDBCluster_EndpointProperty(p) {
}
function _aws_cdk_aws_rds_CfnDBCluster_MasterUserSecretProperty(p) {
}
function _aws_cdk_aws_rds_CfnDBCluster_ReadEndpointProperty(p) {
}
function _aws_cdk_aws_rds_CfnDBCluster_ScalingConfigurationProperty(p) {
}
function _aws_cdk_aws_rds_CfnDBCluster_ServerlessV2ScalingConfigurationProperty(p) {
}
...
function _aws_cdk_aws_rds_CfnDBInstance_CertificateDetailsProperty(p) {
}
...
function _aws_cdk_aws_rds_CfnDBInstance_MasterUserSecretProperty(p) {
}
...
function _aws_cdk_aws_rds_CfnDBProxyProps(p) {
    ...
    try {
        if (p.tags != null)
            for (const o of p.tags)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_CfnDBProxy_TagFormatProperty(o);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_aws_rds_CfnDBProxyEndpointProps(p) {
    ...
    try {
        if (p.tags != null)
            for (const o of p.tags)
                if (!visitedObjects.has(o))
                    _aws_cdk_aws_rds_CfnDBProxyEndpoint_TagFormatProperty(o);
    }
    finally {
        visitedObjects.delete(p);
    }
